...
<template>
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        <div class="col">
          <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" type="text" required placeholder="Digite aqui a descricao da tarefa" class="form-control">
        </div>
        <div class="col-md-2">
